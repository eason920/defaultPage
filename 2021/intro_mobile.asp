...
<!--link href="../defaultPage/2021/css/mb.css?<%=now()%>" rel="stylesheet"-->
...
<div class="all">
	...
	<!------------------->
	<div id="kv">
		<img id="kv-default" src='../defaultPage/2021/images/2021/mb_default.png'/>
		<!--img id="kv-title" src='../defaultPage/2021/images/2021/mb_title.png?<%=now%>'/>
		<img id="kv-empty"
			src="../defaultPage/2021/images/2021/mb_empty.png?<%=now%>"
			onclick="Fa(127);fun_channel_MB('join')"
		/-->
		<img id="kv2"
			src='../defaultPage/2021/images/2021/mb_kv2.jpg?<%=now%>'
			onclick="Fa(127);fun_channel_MB('join')"
		/>
	</div>
	<script>
...
<script src="../defaultPage/2021/js/main-mobile.js" ></script>
