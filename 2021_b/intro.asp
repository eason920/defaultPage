...
<link rel="alternate" media="only screen and (max-width: 640px)" href="https://funday.asia/NewMylessonMobile/join-select.htm" />
...
})(window,document,'script','dataLayer','GTM-KJSTHMB');</script>
...
<!-- Global site tag (gtag.js) - Google Ads: 748725678 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-748725678"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-748725678');
</script>
...
<link href="../../../defaultPage/2021_b/css/pc.css?<%=now()%>" rel="stylesheet">
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KJSTHMB"
...
<div class="all">
	...
	<div class="area5">
		<div class="ItemList">
			<div class="Slogn">超過 10,000 名學員實證分享 聽聽他們怎麼說</div>
		...
		<table width="90%" align="center" border="0" cellpadding="0" cellspacing="0">
				<tr valign="top">
					...
					<div class="Slogn">與我們聯絡</div> 
						...
						<li >service@funday.asia<br/>服務時間：週一～週日14:00~17:30、18:30~22:00</li>    
						</ul>      
					</td>
...
<script src="../../../defaultPage/2021_b/js/main.js?a<%=now()%>" ></script>